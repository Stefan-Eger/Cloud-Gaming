...
#ifndef VE_SUBRENDER_DF_H
#define VE_SUBRENDER_DF_H
...
namespace ve
{
	...
	/**
		...
		*
		*/
	class VESubrenderDF : public VESubrender
	{
	protected:
		VERendererDeferred &m_renderer;
	...
	public:
		...
		VESubrenderDF(VERendererDeferred &renderer)
			: m_renderer(renderer) {};

		///Destructor of subrender fw class
		virtual ~VESubrenderDF() {};
