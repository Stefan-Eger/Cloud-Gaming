...
namespace ve
{
	...
	*
	*/
	void VESubrenderRayTracingKHR::bindDescriptorSetsPerFrame(VkCommandBuffer commandBuffer,
		uint32_t imageIndex,
		VECamera *pCamera,
		VELight *pLight,
	...
	*
	*/
	void VESubrenderRayTracingKHR::bindDescriptorSetsPerEntity(VkCommandBuffer commandBuffer,
		uint32_t imageIndex,
		VEEntity *entity)
	{
		//set 0...cam UBO
	...
	*
	*/
	void VESubrenderRayTracingKHR::draw(VkCommandBuffer commandBuffer,
		uint32_t imageIndex,
		uint32_t numPass,
		VECamera *pCamera,
		VELight *pLight,
	...
	*
	*/
	void VESubrenderRayTracingKHR::drawEntity(VkCommandBuffer commandBuffer,
		uint32_t imageIndex,
		VEEntity *entity)
	{
	}
