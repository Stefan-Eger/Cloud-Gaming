...
#ifndef VHSUBRENDER_RAYTRACING_KHR_H
#define VHSUBRENDER_RAYTRACING_KHR_H

#include "VESubrender.h"

namespace ve
{
	class VERendererRayTracingKHR;
	...
	/**
		...
		*
		*/
	class VESubrenderRayTracingKHR : public VESubrender
	{
	public:
	protected:
		VERendererRayTracingKHR &m_renderer;
		uint32_t m_resourceArrayLength = 256; ///<Length of resource array in shader
	...
	public:
		...
		VESubrenderRayTracingKHR(VERendererRayTracingKHR &renderer)
			: m_renderer(renderer) {};

		///Destructor of subrender fw class
		virtual ~VESubrenderRayTracingKHR() {};
